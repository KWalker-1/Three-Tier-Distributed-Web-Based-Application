...
<body>
    ...
    <div class="container">
        ...
        <p class="info-message">You are connected to the Project 3 Enterprise System database as a <span style="color: red;">client-level</span> user.</p>
        <p class="info-message">Please enter any SQL query or update command in the box below.</p>

        <form class="query-form" action="ExecuteQueryServlet" method="post">
